...
print("Среднее арифметическое данного массива",numpy.mean(a))
...
def bank():
    profit=0.1
    print("Сумма пользователя, которую он положил в банк?")
    a1=int(input())
    print("На сколько лет открыт счёт??")
    years=int(input())
    d=a1*(1+profit)**years
    print("Получает кол-во", d, "рублей")
bank()
